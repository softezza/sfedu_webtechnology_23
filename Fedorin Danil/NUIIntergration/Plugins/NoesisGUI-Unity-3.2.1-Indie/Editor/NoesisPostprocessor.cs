                ...
                d = () =>
                {
                    if (!EditorApplication.isCompiling && !EditorApplication.isUpdating)
                    {
                        ...
                        try
                        {
                            ...
                            if (xaml != null)
                            {
                                // Show parsing errors in the console and dispose the instance
                                // as soon as possible to avoid hot-reloading it (until GC kills it)
                                Noesis.BaseComponent obj = xaml.Load() as Noesis.BaseComponent;
                                obj?.Dispose();
