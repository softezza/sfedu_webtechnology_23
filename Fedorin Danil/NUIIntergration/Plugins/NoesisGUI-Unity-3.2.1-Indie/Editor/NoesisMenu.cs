...
public class NoesisMenu
{
    ...
    [UnityEditor.MenuItem("Tools/NoesisGUI/Welcome Screen...", false, 30101)]
    static void OpenWelcome()
    {
        NoesisWelcome.Open();
    }

    [UnityEditor.MenuItem("Tools/NoesisGUI/VS Code Extension...", false, 30102)]
    static void OpenVSCode()
    {
        UnityEngine.Application.OpenURL("https://marketplace.visualstudio.com/items?itemName=NoesisTechnologies.noesisgui-tools");
    }
    ...
    {
        string docPath = Path.GetFullPath("Packages/com.noesis.noesisgui/Documentation~/Doc/Gui.Core.Changelog.html");
    ...
    internal class DoCreateUserControl : EndNameEditAction
    {
        public override void Action(int instanceId, string pathName, string resourceFile)
        {
            ...
            var code = System.String.Join(System.Environment.NewLine,
              ...
              "namespace Testing",
              "{",
              "    public partial class %NAME%: Noesis.UserControl",
              "    {",
              "        public %NAME%()",
              "        {",
              "            InitializeComponent();",
