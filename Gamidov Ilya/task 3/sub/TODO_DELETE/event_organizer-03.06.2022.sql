...
INSERT INTO `competitions` (`id`, `event_id`, `competition_name`, `maximum_score`) VALUES
(3, 21, 'конкурс', 32),
(4, 22, 'Фото', 10),
(5, 32, 'nnnnnn', 1),
(6, 32, 'rferfвава', 1),
...
INSERT INTO `events` (`id`, `event_name`, `event_name_translite`) VALUES
(21, 'имя', 'name'),
(22, 'Студ-Весна', 'stud-vesna'),
(23, 'Студ-Весна2', 'stud-vesna2'),
(32, 'Студ-Весна23', 'stud-vesna23'),
(33, 'Студ-Весна234', 'stud-vesna234'),
(35, 'Test', 'test'),
(36, 'Диплом', 'diplom');
